...
const viewAlert = ({
    ...
    if (type === 'success') {
        ...
        alert.classList.add('bg-brand-green');
    } else if (type === 'failed') {
 ...
 * @param {boolean} wCenter Modal 안쪽의 수평 센터 정렬 설정 여부, default = false
 ...
 * @example
 * viewModal({
 *         id: 'modal4', vCenter: true, wCenter:true, btnCount: 2,
...
const viewModal = ({
    ...
    modal.innerHTML = `<div class="modal-dialog modal-dialog-centered modal-dialog-lg">
                         <div class="modal-content">
                           ...
                           <div class="modal-body">
                             <div class="row">
                               <div class="col-12 modal-description medium-h5 ${wCenter === true ? 'text-center' : void (0)}">
                                 ${desc}
                               </div>
                             </div>
                           </div>
                           <div class="modal-footer ${wCenter === true ? 'justify-content-center' : void (0)}" count="${btnCount}">
                           </div>
                         </div>
                       </div>`;
    ...
    if (btnCount === 0) {
        ...
        button.classList.add('btn', 'btn-md', 'btn-brand', 'medium-h5');
        ...
        cancelBtn.classList.add('btn', 'btn-md', 'btn-gray-high-light', 'medium-h5');
        ...
        confirmBtn.classList.add('btn', 'btn-md', 'btn-brand', 'medium-h5');
