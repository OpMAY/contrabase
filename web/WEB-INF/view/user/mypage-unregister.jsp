    ...
    <div class="container common-container">
        <div class="row">
            <div class="col-12 pt-16 pl-24 pr-24 medium-h5 c-basic-black">
                <label class="medium-h6 c-gray-dark-low">탈퇴 이유가 무엇인가요?</label>
            </div>
        </div>

        <div class="row">
            <div class="pt-16 pl-24">
                <button type="button" class="btn btn-block btn-box is-active" data-reason="없음">
            ...
            <div class="pt-16 pl-16">
                <button type="button" class="btn btn-block btn-box" data-reason="일감이 없어서요.">
                    <span class="medium-h6 my-auto ">
                        일감이 없어서요.
                    </span>
                </button>
            ...
            <div class="pt-16 pl-16">
                <button type="button" class="btn btn-block btn-box" data-reason="앱이 불편해요">
                    <span class="medium-h6 my-auto ">
                        앱이 불편해요
                    </span>
                </button>
        ...
        <div class="row">
            <div class="pt-16 pl-24">
                <button type="button" class="btn btn-block btn-box" data-reason="기사가 없어서요.">
                    <span class="medium-h6 my-auto ">
                        기사가 없어서요.
                    </span>
                </button>
            ...
            <div class="pt-16 pl-16">
                <button type="button" class="btn btn-block btn-box" data-reason="앱의 오류가 있어서요.">
                    <span class="medium-h6 my-auto ">
                        앱의 오류가 있어서요.
                    </span>
                </button>
        ...
        <div class="row">
            <div class="col-12 pt-32 pl-24 pr-24 medium-h5 c-basic-black">
                <label class="medium-h6 c-gray-dark-low">회원탈퇴 안내</label>
            </div>
        </div>
        <div class="row">
            <div class="col-12 pl-24 pr-24 pt-16 medium-h5 c-basic-black">
                <div class="bg-point">
                    <div class="d-flex justify-content-start p-16">
                        <div>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                ...
                                <defs>
                                    <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                                        <use xlink:href="#image0_142_898" transform="scale(0.00195312)"/>
                                    </pattern>
                                    <image id="image0_142_898" width="512" height="512"
                        ...
                        <div class="medium-h6 c-basic-black pl-16" style="padding-top: 3px">
                            탈퇴 전 반드시 확인해주세요.
                        </div>
                    </div>
                    <div class="regular-p1 pl-16 pr-16">
                        회원탈퇴 후 회워 정보 및 이용 기록은 삭제됩니다.
                    </div>
                    <div class="regular-p1 pl-16 pr-16 pt-16">
                        회원정보가 삭제되어 추후 상담 업무가 제한됩니다.
                    </div>
                    <div class="regular-p1 pl-16 pr-16 pt-16">
                        서비스 포인트는 모두 소멸됩니다.<span class="c-brand-blue">(재가입 시 복구 불가)</span>
                    </div>
                    <div class="regular-p1 pl-16 pr-16 pt-16 pb-24">
                        동일한 계정으로 재가입은 24시간 이후 가능합니다.
                    </div>
                </div>
...
<script>
    ...
    function reasonClickEventListener(event) {
        let reasons = document.querySelectorAll('.btn-box[data-reason]');
        reasons.forEach(function (reason) {
            reason.classList.remove('is-active');
        });
