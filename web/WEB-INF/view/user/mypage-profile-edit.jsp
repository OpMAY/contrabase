    ...
    <div class="container" style="padding-top: 72px; padding-bottom: 56px">
        ...
        <div class="row">
            <div class="col-12 pt-32 pl-24 pr-24 medium-h5 c-basic-black">
                ...
                <div class="form-group form-inner-button">
                    <input type="text" placeholder="이름을 입력해주세요." class="form-control input-box medium-h5">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 pt-32 pl-24 pr-24 medium-h5 c-basic-black">
                ...
                <div class="form-group form-inner-button">
                    <input type="text" placeholder="연락처를 입력해주세요." class="form-control input-box medium-h5">
                </div>
            </div>
        </div>
