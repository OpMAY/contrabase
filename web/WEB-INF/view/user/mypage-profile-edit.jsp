...
<div class="content-container">
    ...
    <jsp:include page="../../view/common/header.jsp" flush="false">
        <jsp:param name="title" value="기본 정보 변경"/>
    ...
    <div class="container common-container">
        <div class="row">
            <div class="col-12 pt-32 pl-24 pr-24 medium-h5 c-basic-black">
                <label class="medium-h6 c-gray-dark-low">이메일</label>
                <div class="form-group form-inner-button">
                    <input type="text" name="email" value="${employee.user.email}" placeholder="이메일을 입력해주세요."
        ...
        <div class="row">
            <div class="col-12 pt-32 pl-24 pr-24 medium-h5 c-basic-black">
                <label class="medium-h6 c-gray-dark-low">이름</label>
                <div class="form-group form-inner-button">
                    <input type="text" name="name" value="${employee.user.name}" placeholder="이름을 입력해주세요."
                           class="form-control input-box medium-h5">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 pt-32 pl-24 pr-24 medium-h5 c-basic-black">
                <label class="medium-h6 c-gray-dark-low">연락처</label>
                <div class="form-group form-inner-button">
                    <input type="text" name="phone" value="${employee.user.phone}" placeholder="연락처를 입력해주세요."
                           class="form-control input-box medium-h5">
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        btn_update.addEventListener('click', function (event) {
            ...
            if (verifyDefaultSubmit()) {
                profileDefaultChange('user', name.value, phone.value, email.value).then((result) => {
                    console.log('apiUpdateDefault', result);
                    if (result.status === 'OK') {
                        viewAlert({content: '기본 정보를 변경하였습니다.'});
                    } else {
                        viewAlert({content: '기본 정보를 변경할 수 없습니다. 다시 시도해주세요.'});
                    }
                });
            } else {
                return;
